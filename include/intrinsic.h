...
__attribute__((always_inline)) static __inline void lgdt(const struct desc_ptr *dtr) {
...
__attribute__((always_inline)) static __inline void lidt(const struct desc_ptr *dtr) {
